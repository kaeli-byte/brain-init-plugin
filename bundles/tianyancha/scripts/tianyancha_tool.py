#!/usr/bin/env python3
"""Call Tianyancha through agent-gw data source tools."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    describe_parser = subparsers.add_parser("describe", help="Print Tianyancha Markdown docs")
    describe_parser.add_argument("--data-source", default=DATA_SOURCE_NAME)
    describe_parser.set_defaults(func=describe)

    call_parser = subparsers.add_parser("call", help="Call a Tianyancha API")
