...
This skill is the **first step** in the `/capture` pipeline. After conversion:

1. Verify markdown quality (check headers, financial sections present)
2. Run `/capture` or use specialist agents for claim extraction
...
# (use parallel agents or sequential /capture commands)
```
